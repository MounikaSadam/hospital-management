...
<br>
<br>
DOCTOR NAME<input type="text" name="t2" maxlength=30 size=20 value=<%=b%>><BR>
...
FATHER'S NAME<input type="text" name="t6" maxlength=40 size=20 value=<%=g%>><BR>
EMAIL ID<input type="text" name="t7" maxlength=40 size=20 value=<%=h%>><BR>
